...
function confirmDeletion() {
    return confirm('Tem certeza que deseja deletar este subcategorias?'); //o método confirm() é um método embutido (nativo) do JavaScript. Ele exibe uma caixa de diálogo com uma mensagem e dois botões: "OK" e "Cancelar". Este método é comumente usado para solicitar uma confirmação do usuário antes de realizar uma ação importante, como deletar um item. confirm(...) mostra uma janela modal com “OK” e “Cancelar”. Se o usuário clicar em OK, confirm(...) retorna true → o link é seguido. Se clicar em Cancelar, retorna false → nada acontece.
}
</script>

</head>
<body>
<h2>Subcategorias Cadastrados</h2>
<table>
    <tr>
        <th>ID </th>
        <th>ID Categoria</th>
    ...
    <tr>
        ...
        <td><?php echo $sub['id_categoria']; ?></td>
        ...
        <td>
            <a href="editar_subcategoria.php?id=<?php echo $prod['id_sub']; ?>" class="action-btn">Editar</a>
            ...
            <a href="excluir_subcategoria.php?id=<?php echo $adm['id_sub']; ?>" class="action-btn delete-btn" onclick="return confirmDeletion();">Excluir</a>
...
<a href="cadastrar_subcategorias.php">Cadastrar nova subcategoria</a>
