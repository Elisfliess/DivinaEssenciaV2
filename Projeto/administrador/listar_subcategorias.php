...
<table>
    ...
    <tr>
        ...
        <td>
            <a href="editar_categorias.php?id=<?php echo $subcateg['id_sub']; ?>" class="action-btn">Editar</a>
            ...
            <a href="excluir_categorias.php?id=<?php echo $subcateg['id_sub']; ?>" class="action-btn delete-btn" onclick="return confirmDeletion();">Excluir</a>
