...
$produtos = []; // Inicializa como array vazio
...
try {
    ...
    $stmt = $pdo->prepare("SELECT * FROM produto"); //vai buscar todas as colunas da tabela ADMINISTRADOR
    $stmt->execute();  //***vide explicações sobre a dinâmica desses comandos no final do arquivo
    $produtos = $stmt->fetchAll(PDO::FETCH_ASSOC); //fetch = recuperar, buscar
...
<tr>
    ...
    <tr>
        ...
        <td>
            <a href="editar_produto.php?id=<?php echo $prod['id_produto']; ?>" class="action-btn">Editar</a>
            ...
            <a href="excluir_produto.php?id=<?php echo $prod['id_produto']; ?>" class="action-btn delete-btn" onclick="return confirmDeletion();">Excluir</a>
...
<a href="cadastrar_produtos.php">Cadastrar novo produto</a>
