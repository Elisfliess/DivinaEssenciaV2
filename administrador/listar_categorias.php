...
<table>
    ...
    <tr>
        ...
        <td>
            <a href="editar_categorias.php?id=<?php echo $adm['id_categoria']; ?>" class="action-btn">Editar</a>
            ...
            <a href="excluir_categorias.php?id=<?php echo $adm['id_categoria']; ?>" class="action-btn delete-btn" onclick="return confirmDeletion();">Excluir</a>
